        ...
        {loading ? (
          ...
          <ChartContainer config={chartConfig} className="h-[300px] w-full aspect-auto px-2 pb-4 pt-5 sm:px-4">
            <AreaChart accessibilityLayer data={data} margin={{ top: 8, right: 8, left: -14, bottom: 0 }}>
              <defs>
                <linearGradient id="userPressureFill" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="var(--color-pressure)" stopOpacity={0.28} />
                  <stop offset="95%" stopColor="var(--color-pressure)" stopOpacity={0.02} />
                </linearGradient>
              </defs>
              ...
              <ChartTooltip
                ...
                content={
                  <ChartTooltipContent
                    ...
                    valueFormatter={(value) => `${Number(value).toFixed(3)} kPa`}
                  />
                }
              />
              <Area
